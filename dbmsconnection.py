...
def register():
    ...
    cursor.execute('INSERT INTO users (username, password) VALUES (%s, %s)', (name, pwd))
    db.commit()
...
def quiz(subject, user, quiz_data):
    ...
    cursor.execute('INSERT INTO quiz_results (username, subject, score) VALUES (%s, %s, %s)', (user, subject, score))
    db.commit()
